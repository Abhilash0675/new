...
public class TestListUnitPublicUsingRightClick extends BaseTest {
	...
	public void toListPublic() throws Exception{
		TestListUnitRightClickPage testListUnitRightClickPage = new TestListUnitRightClickPage(driver,configurationReader,browserName);
		boolean status = testListUnitRightClickPage.toListPublic();
		handleAssert(status);
	}
	
	@Test(dependsOnMethods={"toListPublic"})
