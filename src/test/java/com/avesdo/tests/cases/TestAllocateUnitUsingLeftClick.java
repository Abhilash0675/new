...
public class TestAllocateUnitUsingLeftClick extends BaseTest {
	...
	public void toAllocate() throws Exception{
		TestAllocateLeftClickPage testAllocateLeftClickPage = new TestAllocateLeftClickPage(driver,configurationReader,browserName);
		boolean status = testAllocateLeftClickPage.toAllocate();
		handleAssert(status);
	}
